...
var window_background = "#f7f7f7"; // the color of the pop-up window
var window_border = "#e8e4e4"; // the border color of pop-up window //#6FC4D5
...
var window_height = 110//weight of window
...
function create_div(dleft, dtop, dwidth, dheight)
{
	...
	+ 'Seach for Name or Ext#: '
	+ '<input type="text" size="25" maxlength="25" id="fwtext"'
	+ ' onchange="resettext();">'
	+ '<input type="button" value="Find Previous  " onclick="findprev();">'
...
document.write('<input type="button" value="Click to Search for Name or Ext #"'
	+ ' onclick="show();">');
