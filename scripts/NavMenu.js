var NavMenuOptions = {
    menuId: "NavMenu",
    linkIdToMenuHtml: "NavMenu",
    effect: "fade", //"slide", "fade", or "none"
    open: "onmouseover", // or "onclick" "onmouseover"
    speed: 200,
    delay: 0,
    license: "mylicense"
};
 
var NavMenu = new McNavMenu(NavMenuOptions);
 
 
function McNavMenu(m) {
    ...
    var db = function (a, b) {
        ...
        v = navigator,
        S = function (b, d) {
            if (k.getComputedStyle) var c = k.getComputedStyle(b, null);
        ...
        N = function (a) {
            ...
            else k.event.cancelBubble = true
        },
        X = function (a) {
            var b = a ? a : k.event;
        ...
        w = "zIndex",
        z = "onclick",
        rb = "NavMenu trial version",
        g = [],
        b, U, B, u, n, i = function () {
            return n && n[y]
        };
    ...
    if (H)
        if (v.msPointerEnabled) var T = "MSPointerOver",
            V = "MSPointerOut";
        else {
            T = "pointerOver";
            V = "pointerOut"
    ...
    var R = function (a) {
        ...
        J = function (b) {
            var a = g[c];
            while (a--) g[a].a != null && b != g[a] && g[a].l()
        },
        ...
        D = function (e) {
            var a = e.childNodes,
                d = [];
            if (a)
                for (var b = 0, f = a[c]; b < f; b++) a[b].nodeType == 1 && d.push(a[b]);
            return d
        },
        eb = function (a) {
        ...
        nb = function (h, a) {
            var b = function (a) {
                    for (var d = unescape(a.substr(0, a[c] - 1)), f = a.substr(a[c] - 1, 1), e = "", b = 0; b < d[c]; b++) e += String.fromCharCode(d.charCodeAt(b) - f);
                    return unescape(e)
                },
                e = f.domain,
                d = Math.random(),
            ...
            if (P(a + d)[c] % g[c] > 8) try {
                a = (new Function("$", "_", "e", P(U, d[c]))).apply(this, [g, a, d])
            } catch (i) {} else d < .14 && (!e || e == b("qthfqmtxy5")) && a != "6c0l6" && h[r].appendChild(f[b("hwjfyjYj}yStij5")](b("iirjsz%ywnfq%{jwxnts5")))
        },
        l = k.clearTimeout,
        t = k.setTimeout,
        F = "createElement",
        ...
        P = function (e, b) {
            for (var d = [], a = 0; a < e[c]; a++) d[d[c]] = String.fromCharCode(e.charCodeAt(a) - (b && b > 7 ? b : 3));
            return d.join("")
        },
        mb = function (a, d) {
            var b = a[c];
        ...
        G = function (c, f, g) {
            for (var a = [], e = Math.ceil(g / 16), d = 1; d <= e; d++)
                if (b.c == 2) a.push(c + ab(d / e, 2) * (f - c));
                else a.push(Math.round(c + ab(d / e, 2.5) * (f - c)));
            a.Q = 0;
            return a
        },
        K = function (a) {
    ...
    Z.prototype = {
        ...
        g: function () {
            ...
            if (m[c] == 2) {
                ...
                var r;
                while (r == g.nextSibling) g.appendChild(r);
                g[a].top = "auto";
                g[a].bottom = "0";
                var o = g.offsetTop,
                    l = t - o - g.clientHeight;
                if (l < 0) l = 0;
                ...
                f.a.pA = k;
                f.a.sI = g;
                if (b.g == z) e(f.b, "click", function (a) {
                    R(a);
                    f.ia(a)
                });
                else if (H) {
                    ...
                    if (C) f.b.ontouchstart = function (a) {
                        a[h].by = 1;
                        a[h].ta && f.ia(a)
                    };
                    else if (n) f.b[z] = function (a) {
                        if (i()) {
                            a[h].by = 1;
                            a[h].ta && f.ia(a)
                        }
        ...
        ia: function (d) {
            ...
            this.i(d);
            if (McDDs[c] > 1)
                for (var a = 0; a < McDDs[c]; a++) McDDs[a].a != b.b && McDDs[a].c()
        },
        o: function () {
            if (this.a[a][d] != "none") {
                var e = this,
                ...
                e.e = setInterval(function () {
                    if (++f.Q < f[c]) e.a[a][o] = f[f.Q] + "px";
                    else if (e.a[a][o] == "2px") {
                        e.a[a][d] = "none";
                        e.a[a][o] = "0px";
                        e.b[a][w] = 0;
                        l(e.e)
                    } else e.a[a][q] = e.a[a][o] = "2px"
                }, 16)
            }
        },
        p: function () {
        ...
        i: function (c) {
            ...
            if (b.g == z || i() || H && !K(c) || C && c[h].by == 1) a.d = t(function () {
                if (a.s < 1) a.k();
                else a.l()
            }, a.s < 1 ? 0 : 50);
            else a.d = t(function () {
    ...
    cb.prototype = {
        ...
        r: function (d) {
            ...
            (new Function("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "z", "y", "x", function (d) {
                for (var b = [], a = 0, e = d[c]; a < e; a++) b[b[c]] = String.fromCharCode(d.charCodeAt(a) - 4);
                return b.join("")
    ...
    var gb = function (c) {
        ...
        W = function () {
            ...
            r = "parentNode", a = "style", d = "display", O = "nodeName", I = "offsetHeight";
            if (b.e) {
        ...
        lb = function (d) {
            ...
            if (f[E]) f[E]("DOMContentLoaded", a, false);
