...
<html>
    <head>
        ...
        <title>Dress Code p\Policy</title>
    ...
    <body>
        ...
        <article id="hr">
            ...
            <object data="../DocsToUpload/DressCodePolicy.pdf" type="application/pdf">
                <p><a href="../DocsToUpload/DressCodePolicy.pdf">Click Here to view This Document on a Mobile Device</a></p>
            </object>
