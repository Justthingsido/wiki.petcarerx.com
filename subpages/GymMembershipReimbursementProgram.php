...
<html>
    <head>
        ...
        <title>GYM Reimbursement Program</title>
    ...
    <body>
        ...
        <article id="hr">
            <h1>Gym Membership Reimbursement Program</h1>
            <object data="../DocsToUpload/GymMembershipReimbursementProgram.pdf" type="application/pdf">
                <p><a href="../DocsToUpload/GymMembershipReimbursementProgram.pdf">Click Here to view This Document on a Mobile Device</a></p>
            </object>
        </article>
