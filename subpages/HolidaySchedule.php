...
<html>
    ...
    <body>
        ...
        </header>        <article id="hr">
            <h1>2015 Holiday Schedule</h1>
            <object data="../DocsToUpload/HolidaySchedule.pdf" type="application/pdf">
                <p><a href="../DocsToUpload/HolidaySchedule.pdf">Click Here to view This Document on a Mobile Device</a></p>
            </object>
